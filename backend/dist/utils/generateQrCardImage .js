 ...
 */
const generateQrCardImage = async ({ restaurantName, tableNumber, capacity, qrCodeDataUrl, }) => {
    const html = `
  <html>
    <head>
      <style>
 ...
 * Send QR email
 */
export const sendTableQrEmail = async (data, email) => {
...
//# sourceMappingURL=generateQrCardImage%20.js.map